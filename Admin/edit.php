...
while($row = mysqli_fetch_assoc($get_record)) {
   ...
   echo $db_middle_name = $row["middle_name"];
   echo $db_last_name = $row["last_name"];
   echo $db_gender = $row["gender"];
...
$new_gender_name = $_POST["new_gender"];

if($new_first_name && $new_middle_name && $new_last_name && $new_email){

    mysqli_query($connections, "UPDATE user SET
first_name='$new_first_name', middle_name='$new_middle_name', last_name='$new_last_name', gender='$new_gender_name', email='$new_email'  WHERE user_id='$user_id'");
